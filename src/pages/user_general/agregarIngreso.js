...
class AgregarIngreso extends React.Component{
        ...
        return <div className="container">
                    ...
                    <form onSubmit={this.handleSubmit} className="row g-3" >
                        ...
                        <div className="col-6">
                            ...
                            <select name="tipoIngreso" id="tipoIngreso" onChange={this.handleChange} className="form-select">
                                <option value="0" defaultValue>---</option>
                                {this.state.tipoIngDesc.map((item, index) => {
                                    if(item.status && item.tipoIngreso_Descuento === 1)
                                    {
